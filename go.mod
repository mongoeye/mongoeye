module github.com/mongoeye/mongoeye
...
require (
	...
	github.com/briandowns/spinner v0.0.0-20170404174923-fb621c2fd72f
	...
	github.com/jinzhu/copier v0.0.0-20170205151647-8bfca8a02a0c
