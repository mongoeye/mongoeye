...
Here are examples of more advanced results that can be generated by Mongoeye. 

It is necessary to set output in JSON (`--format json`) or YAML (`--format yaml`) format.
